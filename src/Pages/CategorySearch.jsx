...
const CategorySearch = () => {
  ...
  const { category } = useParams(); // Dynamically get category from route params
  ...
  useEffect(() => {
    const getData = async () => {
      try {
        ...
        setLoading(false); // Turn off loading in both success and error cases
      }
    };
  ...
  return (
    <div className="deals mt-6 ">
      <div className="max-w-[1600px] mx-auto">
        ...
        >
          <div className="">
            <h1 className="text-white text-3xl md:text-[2.5rem] font-bold capitalize">{category}</h1>
        ...
        <div className="flex  gap-10 px-2 md:px-4 mt-10 mx-1">
          ...
          <div className="w-full lg:w-[70%]">
            ...
            <div className="popularHeader flex items-center justify-between w-[97%] mb-8">
              <h1 className="  ">We found  <span className="text-blue-700 font-bold " >{products.length}</span> items for you!</h1>
